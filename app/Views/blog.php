        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    <?php foreach($postt['data'] as $p) { ?>
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?= base_url('uploads/' . $p['image'])?>" alt="">
                            </div>
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?= base_url('post/blog/'. $p['post_id'])?>">
                                    <h2><?= $p['title']?></h2>
                                </a>
                                <p><?= $p['content']?></p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i><?= $p['category_name']?></a></li>
                                    <li><a href="#"><i class="flaticon-calendar-1"></i><?= $p['date']?> </a></li>
                                </ul>
                            </div>
                        </article>
                    <?php } ?>

                    <?= $postt['pager']->links('postt', 'bootstrap') ?>
                    </div>
                </div>
                <div class="col-lg-4">
