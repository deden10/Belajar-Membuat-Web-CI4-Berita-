            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="section_title text-center mb-70">
                        ...
                        <p>Kami menyajikan berita secara fakta dan aktual serta didukung dengan data yang valid dari narasumber</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        ...
                        <div class="news_info">
                            ...
                            <p class="d-flex align-items-center"> <span><i class="flaticon-calendar-1"></i> <?= $p['date']?></span> 
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-7">
                            <div class="footer_widget">
                                ...
                                <form action="<?= base_url('post/search')?>" class="newsletter_form" method="post">
